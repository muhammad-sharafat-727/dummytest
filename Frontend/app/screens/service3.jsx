        ...
        <View style={styles.content}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.description}>
              Communicate with the AI naturally in both English and Urdu. Get
              medical guidance in the language you are most comfortable with.
            </Text>
          </View>
          ...
          <View style={styles.bottom}>
            ...
            <View style={styles.nextButtonContainer}>
              <TouchableOpacity
                ...
                onPress={() => router.push("/screens/service4")}
              >
                <LinearGradient
